...
- (void)requestData{
    ...
    [RankingHttpTool getRankingWithStart:0 arrayBlock:^(NSMutableArray *resultArray) {
...
- (void)loadMoreData{
    ...
    [RankingHttpTool getRankingWithStart:_resultArray.count arrayBlock:^(NSMutableArray *resultArray) {
...
- (void)initTableView{
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, NAV_BAR_HEIGHT, SCREEN_WIDTH, SCREEN_HEIGHT - NAV_BAR_HEIGHT - TAB_BAR_HEIGHT)];
